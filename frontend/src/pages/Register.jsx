...
const Register = () => {
  ...
  const handleNameChange = (e) => {
    ...
    setName(val);
    if (val.trim().length < 2) setErrors(prev => ({ ...prev, name: 'Name must be at least 2 characters long' }));
    ...
    >
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Join TaskFlow to organize your work.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input 
              type="text" 
              className={`w-full px-4 py-3 rounded-lg border ${errors.name ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none`}
